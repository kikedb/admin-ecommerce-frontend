  ...
  >
    <TransitionGroup name="toast" tag="div" class="flex flex-col gap-3">
      <div
        ...
        :key="notification.id"
        :class="[
          'pointer-events-auto animate-in fade-in slide-in-from-right-5 duration-300',
          'px-4 py-3 rounded-lg shadow-lg border flex items-start gap-3 group',
          getNotificationClasses(notification.type)
        ]"
      >
        <!-- Icon -->
        <div class="flex-shrink-0 mt-0.5 flex-shrink-0">
        ...
        <button
          ...
          class="flex-shrink-0 ml-2 text-current opacity-60 hover:opacity-100 transition"
        >
